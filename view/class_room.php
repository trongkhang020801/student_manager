						...
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Tên Lớp</label>
                      			<input type="text" class="form-control" id="name" placeholder="Nhập tên lớp!" name="name" autocomplete="off">                    
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Số sinh viên</label>
                      			<input type="text" class="form-control" id="student_count" placeholder="Nhập số sinh viên!" name="student_count"autocomplete="off">
                    		</div>
                		</div><!-- /.box-body -->
        	...
        	<div class="col-md-8">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">Tất cả lớp</h3>
                	</div><!-- /.box-header -->
...
if($cant_remove > 0 ||  $cant_remove1 > 0){
	...
	echo '<a href="#modalUpdateform" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="'.$id.'" data-toggle="modal">Chỉnh sửa</a>';
	
}else{
	
	echo '<a href="#modalUpdateform" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="'.$id.'" data-toggle="modal">Chỉnh Sửa</a>';
	echo ' <a href="#" class="confirm-delete btn btn-danger btn-xs"  data-id="'.$id.'">Xóa</a>';
                		...
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Chỉnh sửa lớp.</h4>
   							</div>
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updateclassroom(this)" id="btnSubmit1" class="btn btn-info" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>Cập Nhật</button>
                            </div><!--/.panel-footer-->  
            			</div><!--/.panel--> 
            		</div><!--/.col-md-6-->
            	</div><!--/.row-->                                    
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				<div class="modal-header bg-primary">
        			...
        			<h4 class="modal-title" id="frm_title">Xóa</h4>
      			</div>

				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Bạn có chắc không?</strong>  Bạn có muốn xóa bản ghi này không
        		</div>
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Có</a><!-- MSK-000125 -->
        			<button type="button" class="btn btn-primary col-sm-2 pull-right" data-dismiss="modal" id="frm_cancel">Không</button>
      			</div>
    		</div>
  		</div>
	</div>
