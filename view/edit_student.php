            ...
            <div class="col-md-12">
              	<div class="box box-primary">
                	<div class="box-header with-border">
                        ...
                        <a href="all_student.php?do=showSTable&grade_id=<?php echo $grade_id; ?>" style="float:right" type="button" class="btn text-right btn-success asd" id="btnSubmit2"><span class="glyphicon glyphicon-arrow-left"></span> Trở loại</a>
                	</div><!-- /.box-header -->
                   	<form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                        		<div class="col-md-6">
                                	<p class="alert-warning ">Thông tin sinh viên</p>
                                     <div class="form-group" id="divFullName">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Họ tên</label>
                                        </div>
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Nhập họ tên" name="full_name" id="full_name" autocomplete="off" value="<?php echo $row['full_name']; ?>">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Nhập bí danh" name="i_name" id="i_name" autocomplete="off" value="<?php echo $row['i_name']; ?>">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divAddress">
                                        ...
                                        <div class="col-xs-9" id="divAddress1">
                                           <input type="text" class="form-control" placeholder="Nhập địa chỉ" name="address" id="address" autocomplete="off" value="<?php echo $row['address']; ?>"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divEmail">
                                        ...
                                        <div class="col-xs-9" id="divEmail1">
                                           <input type="text" class="form-control" placeholder="Nhập Email" name="email" id="email" autocomplete="off" value="<?php echo $row['email']; ?>"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divGender">
                                                ...
                                                <div class="col-xs-7" id="divGender1">
                                                 	<select name="gender" class="form-control" id="gender" >
                                                         <option value="Male"<?=$row['gender'] == 'Male' ? ' selected="selected"' : '';?>>Nam</option>
                            							 <option value="Female"<?=$row['gender'] == 'Female' ? ' selected="selected"' : '';?>>Nữ</option>
                                                    </select>                                          
                                                </div> 
                                        	</div> 
                                ...
                                <div class="col-md-6">
                                	<p class="alert-warning "> Thông tin người giám hộ </p>
                                     <div class="form-group" id="divGFullName">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Họ tên</label>
                                        </div>
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Nhập họ tên" name="g_full_name" id="g_full_name" autocomplete="off" value="<?php echo $row1['full_name']; ?>">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Nhập bí danh" name="g_i_name" id="g_i_name" autocomplete="off" value="<?php echo $row1['i_name']; ?>">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                           <input type="text" class="form-control" placeholder="Nhập địa chỉ" name="g_address" id="g_address" autocomplete="off" value="<?php echo $row1['address']; ?>"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGEmail">
                                        ...
                                        <div class="col-xs-9" id="divGEmail1">
                                           <input type="text" class="form-control" placeholder="Nhập Email" name="g_email" id="g_email" autocomplete="off" value="<?php echo $row1['email']; ?>"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divGGender">
                                                ...
                                                <div class="col-xs-7"  id="divGGender1">
                                                 	<select name="g_gender" class="form-control" id="g_gender" >
                                                        <option value="Male"<?=$row1['gender'] == 'Male' ? ' selected="selected"' : '';?>>Nam</option>
                                                        <option value="Female"<?=$row1['gender'] == 'Female' ? ' selected="selected"' : '';?>>Nữ</option>
                                                    </select>                                          
                                                </div> 
                                        	</div>   
