                	...
                	<div class="box-header with-border">
                   	...
                   	<form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                        		<div class="col-md-6">
                                	<p class="alert-info "> Chi tiết sinh viên </p>
                                    <div class="form-group" id="divIndexNumber">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Mã SV</label>
                                        </div>
                                        <div class="col-xs-9" id="divIndexNumber1">
                                           <input type="text" class="form-control" placeholder="Nhập mã sinh viên" name="index_number" id="index_number" autocomplete="off">  
                                        </div>                    
                                    </div>
                                     <div class="form-group" id="divFullName">
                                        ...
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Nhập họ tên" name="full_name" id="full_name" autocomplete="off">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Nhập bí danh" name="i_name" id="i_name" autocomplete="off">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divAddress">
                                        ...
                                        <div class="col-xs-9" id="divAddress1">
                                           <input type="text" class="form-control" placeholder="Nhập địa chỉ" name="address" id="address" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divEmail">
                                        ...
                                        <div class="col-xs-9" id="divEmail1">
                                           <input type="text" class="form-control" placeholder="Nhập đỉa chỉ Email" name="email" id="email" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
                                ...
                                <div class="col-md-6">
                                	<p class="alert-info "> Chi tiết Người thân </p>
                                    <div class="form-group" id="divGIndexNumber">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Mã hồ sơ</label>
                                        </div>
                                        <div class="col-xs-9" id="divGIndexNumber1">
                                           <input type="text" class="form-control" placeholder="" name="g_index" id="g_index" autocomplete="off" readonly>  
                                        </div>                    
                                    </div>
                                     <div class="form-group" id="divGFullName">
                                        ...
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Nhập họ tên" name="g_full_name" id="g_full_name" autocomplete="off">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Nhập bí danh" name="g_i_name" id="g_i_name" autocomplete="off">
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                           <input type="text" class="form-control" placeholder="Nhập địa chỉ" name="g_address" id="g_address" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGEmail">
                                        ...
                                        <div class="col-xs-9" id="divGEmail1">
                                           <input type="text" class="form-control" placeholder="Nhập Email" name="g_email" id="g_email" autocomplete="off"> 
                                        </div>                    
                                    </div>
                                    <div class="row" >
                        				<div class="col-xs-7">
