            ...
            <div class="col-md-7">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Thêm Giảng viên</h3>
                    </div><!-- /.box-header -->
                    ...
                    <form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal" >
                        <div class="box-body" >
                        	<div class="form-group" id="divIndexNumber">
                                ...
                                <div class="col-xs-9">
                                    <input type="text" class="form-control" placeholder="Nhập mã giảng viên" name="index_number" id="index_number" autocomplete="off" >  
                                </div>                    
                            </div>
                            <div class="form-group" id="divFullName">
                                ...
                                <div class="col-xs-9">
                                    <input type="text" class="form-control" placeholder="Nhập họ và tên" name="full_name" id="full_name" autocomplete="off">  
                                </div>                    
                            </div>
                            ...
                            <div class="form-group tt2 " id="divEmail">
                                ...
                                <div class="col-xs-6" id="divEmail1">
                                    <input type="text" class="form-control"  placeholder="Nhập email" name="email" id="email" autocomplete="off">
                                </div>
                            </div>
