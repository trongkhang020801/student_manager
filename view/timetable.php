            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">Thêm Thời khóa biểu</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body" >
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showTimeTable(this)">Xem</button><!--MSK-000108-->
                  	</div>
            	</div><!-- /.box -->
        	</div>
    	</div>
    		...
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
      			...
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Có</a><!-- MSK-000154 -->
